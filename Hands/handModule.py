...
class handDetector():
    def __init__(self, mode=False, maxHands=1, detectConf=0.65, modelComlexity = 1, trackConf=0.5):
        self.mode = mode
        ...
        self.hands = self.mpHands.Hands(
            self.mode, self.maxHands, self.modelComlex, self.detectConf, self.trackConf)
